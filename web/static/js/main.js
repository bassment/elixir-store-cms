...
var _user$project$Components_Main_State$init = function () {
...
var _user$project$Components_Main_State$State = F3(
	function (a, b, c) {
		return {input: a, messages: b, phxSocket: c};
	});
...
var _user$project$Main$view = function (state) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Components_Main_View$chatView(state),
			_1: {ctor: '[]'}
		});
};
